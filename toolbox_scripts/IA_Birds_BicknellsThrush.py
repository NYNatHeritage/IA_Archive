...
##arcpy.SelectLayerByAttribute_management("LAYER_EOs", "SUBSET_SELECTION", "\"ELEMTYPE\" = 'C'")
##
##
######################### Clip to >1067m elevation, union them, to the EOs, and then dissolve
#########################
##arcpy.Clip_analysis("LAYER_EOs", "C:/_Schmid/_project/Important_Areas/GIS_Data/IA_Process.gdb/elevGT1067m", "BTComms_clip")
...
arcpy.CopyFeatures_management ("BTElim", "C:/_Schmid/_project/Important_Areas/GIS_Data/OUTPUT.gdb/" + ModelType + tyme + EXorHIST)

arcpy.AddMessage("IA model done: Bicknell's Thrush")
