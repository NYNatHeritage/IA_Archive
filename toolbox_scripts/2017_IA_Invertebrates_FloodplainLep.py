# ---------------------------------------------------------------------------
# IA_Invertebrates_FloodplainLep.py
# Created on: 2012 May
...
ModelType = "Invertebrates_FloodplainLepidoptera"
...
if EXorHIST == "Extant":
    selectQuery = "IA_MODEL = '01ETER_FLD'"
    IAmodel = "01ETER_FLD"
...
##################### Clip out LULC, Union to EOs, and prep for terrestrial model
#####################
...
print("IA model done: Invertebrates_FloodplainLepidoptera")
