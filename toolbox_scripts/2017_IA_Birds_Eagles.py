...
print("Bald Eagle Non-Breeding model")
in_EOs = "in_EOs"
...
print("Bald Eagle Roosting model")
in_EOs = "in_EOs"
...
arcpy.Clip_analysis("F:/_Schmid/_project/Important_Areas/GIS_Data/IA_Process.gdb/HREP_EAHYDRO_SAV", "Final_Buff5000sp", "Clipped_Buff5000sp")
...
arcpy.CopyFeatures_management ("FinalUnion", FinalFC_gdb)

print("IA model done: Bald Eagle.")
