...
ModelType = "Animals_LacustrineNonEOs"
...
print("Basic Lacustrine Animals model")
...
print("Buffer the waterbodies 50 meters to capture relevant non-EOs...")
...
arcpy.MakeFeatureLayer_management("M:\\gis_util\\connectfiles\\gisview@gisprod_default_10.0.sde\\ARCS.surfwatr", "LAYER_surfwater")
...
print("Capture non-EOs with waterbodies...")
...
print("Buffer the EOs 100 meters to capture wetlands...")
...
print("LU/LC SELECT: Run wetlands selection module: CCAP Wetlands...")
...
arcpy.SelectLayerByAttribute_management("LAYER_NWI_polys", "NEW_SELECTION", "\"ATTRIBUTE\" LIKE 'P%' OR \"ATTRIBUTE\" LIKE 'L%'")
arcpy.CopyFeatures_management ("LAYER_NWI_polys", "NWI_wet_polys")
print("LU/LC SELECT: NWI Wetlands have been selected.")
...
print("IA model done: Animals - Lacustrine.")
