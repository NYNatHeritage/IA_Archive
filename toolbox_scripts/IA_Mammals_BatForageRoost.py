...
##################### Erase elevation > 900
#####################
arcpy.Erase_analysis("polys_clip", "C:/_Schmid/_project/Important_Areas/GIS_Data/IA_Process.gdb/elevGT900feet", "EraseElev900ft")
...
arcpy.AddMessage("IA model done: Mammals Bat Foraging and Roosting.")
