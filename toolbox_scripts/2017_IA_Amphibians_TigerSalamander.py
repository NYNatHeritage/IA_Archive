...
print("Tiger Salamander (Ambystoma tigrinum) model")
...
arcpy.SelectLayerByLocation_management("LAYER_Peconic", "INTERSECT", "F:/_Schmid/_project/Important_Areas/GIS_Data/IA_Process.gdb/Peconic_Clip", "", "NEW_SELECTION")
...
print("IA model done: Tiger Salamander.")
