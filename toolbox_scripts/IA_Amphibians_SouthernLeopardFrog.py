...
arcpy.AddMessage("Southern Leopard Frog (Rana sphenocephala) model")
...
def SLFwet(in_SLF, SLF_out, WSP):  
    ...
    ################### 
    arcpy.AddMessage("Determine contiguous DEC wetlands")
...
################### Buffer all: 340m
###################
arcpy.AddMessage("Buffer all: 340m")
...
arcpy.AddMessage("IA model done: Southern Leopard Frog.")
