...
ModelType = "Mammals_BatHibernacula"
...
if EXorHIST == "Extant":
    selectQuery = "IA_MODEL = '01ETER_MYH'"
    IAmodel = "01ETER_MYH"
...
###################
arcpy.Buffer_analysis(in_EOs, "in_EOs_buff", 805, "FULL", "ROUND", "ALL", "")
arcpy.MultipartToSinglepart_management("in_EOs_buff","Dissolve")
...
arcpy.AddMessage("IA model done: Mammals Bat Hibernacula.")
