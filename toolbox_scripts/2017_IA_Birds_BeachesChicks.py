...
if EXorHIST == "Extant":
    selectQuery = "\"IA_MODEL\" = '01ESHR_PIP'"
    IAmodel = "01ESHR_PIP"
elif EXorHIST == "Historical":
    selectQuery = "\"IA_MODEL\" = '01HSHR_PIP'"
    IAmodel = "01HSHR_PIP"


# Select out the proper EOs
arcpy.Select_analysis(in_put, in_EOs, selectQuery)
print("In EOs selected. " + EXorHIST + " Beach birds.")


################### Buffer EOs
###################
arcpy.Buffer_analysis(in_EOs, "in_EOs_buff", 1000, "FULL", "ROUND", "ALL")
print("EOs buffered 200m.")
...
print("IA model done: Beach Birds.")
