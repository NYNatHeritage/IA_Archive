...
arcpy.AddMessage("Spadefoot Toad (Scaphiopus holbrookii) model")
...
arcpy.CopyFeatures_management ("Contiguous_Spade", "C:/_Schmid/_project/Important_Areas/GIS_Data/OUTPUT.gdb/" + ModelType + tyme + EXorHIST)

arcpy.AddMessage("IA model done: Spadefoot Toad.")
