...
arcpy.AddJoin_management("LAYER_EOs", "SCIEN_NAME", "F:/_Schmid/_project/Important_Areas/GIS_Data/IA_Process.gdb/BarrensHabitat", "BarrensHabitat")
...
print("IA model done: Invertebrates_BarrensHabitatLepidoptera")
