...
arcpy.AddJoin_management("LAYER_EOs", "SCIEN_NAME", "C:/_Schmid/_project/Important_Areas/GIS_Data/IA_Process.gdb/OakPineFoodplant", "OakPineFoodplant")
...
arcpy.AddMessage("IA model done: Invertebrates_OakPineFoodplantLepidoptera")
