# ---------------------------------------------------------------------------
# IA_Animals_palustrine_clipped1km.py
# Created on: 2012 May
#   
#   (created by John Schmid, GIS Specialist, NYNHP)
#   (methodology by Hollie Shaw, Zoologist, NYNHP)
# Usage: Important Area Model for palustrine animals - basic methdology, but clipping a
#   distance of 1km from the EO
...
ModelType = "Animals_palBasic1kmClip"
...
if EXorHIST == "Extant":
    selectQuery = "IA_MODEL = '01EPAL_G02'"
    IAmodel = "01EPAL_G02"
...
print("Animals - Palustrine, Basic model")
...
arcpy.Buffer_analysis(in_EOs, "in_EOs_1kmbuff", BuffDist2, "FULL", "ROUND", "ALL", "")
...
################### Run palustrine community module
###################
arcpy.Clip_analysis(out_buff, "in_EOs_1kmbuff", "out_clip")
...
#
arcpy.AddField_management("out_clip", "IA_MODEL_R", "TEXT", "", "20")
arcpy.CalculateField_management("out_clip", "IA_MODEL_R", "'" + IAmodel + "'", "PYTHON")

arcpy.Dissolve_management("out_clip", "Dissolve2", "IA_MODEL_R", "", "SINGLE_PART")
...
print("IA model done: Palustrine Animals - Basic.")
