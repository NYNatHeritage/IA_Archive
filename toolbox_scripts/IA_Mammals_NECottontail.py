...
ModelType = "Mammals_NECottontail"
...
if EXorHIST == "Extant":
    selectQuery = "IA_MODEL = '01ETER_NEC'"
    IAmodel = "01ETER_NEC"
...
###################
arcpy.Buffer_analysis(in_EOs, "in_EOs_buff", 400, "FULL", "ROUND", "ALL", "")
...
arcpy.AddMessage("IA model done: New England Cottontail.")
