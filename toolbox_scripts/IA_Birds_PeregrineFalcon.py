...
ModelType = "Birds_PeregrineFalcon"
...
if EXorHIST == "Extant":
    selectQuery = "IA_MODEL = '01ETER_PEF'"
    IAmodel = "01ETER_PEF"
...
###################
arcpy.Buffer_analysis(in_EOs, "in_EOs_buff", 800, "FULL", "ROUND", "ALL", "")
...
arcpy.AddMessage("IA model done: Peregrine Falcon.")
