...
arcpy.Clip_analysis("Database Connections/bloodhound.sde/AIMS.alisroads", "B4_Merge_BUFF", "roads_within_wet_buff")
...
arcpy.Clip_analysis("Database Connections/bloodhound.sde/AIMS.alisroads", "pSmallmp_BUFF", "roads_200m_fromEO")
