...
print("Codes selected from CCAP")
...
#######################
arcpy.Erase_analysis("preDissolve", "M:\\gis_util\\connectfiles\\gisview@gisprod_default_10.0.sde\\ARCS.surfwatr", "EraseSurfW")
arcpy.Erase_analysis("EraseSurfW", "F:/_Schmid/_project/Important_Areas/GIS_Data/IA_Process.gdb/NEAHC2to5_unshadedstreams", "EraseUnshadeStreams")
arcpy.Erase_analysis("EraseUnshadeStreams", "F:/_Schmid/_project/Important_Areas/GIS_Data/IA_Process.gdb/ALIS_clipped_unshaded_buff25", "EraseUnshadeRoads")
...
print("IA model done: Invertebrates West Virginia White")
