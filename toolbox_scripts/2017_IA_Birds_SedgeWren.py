...
print("LU/LC SELECT: CCAP LU classes have been selected.")
...
arcpy.SelectLayerByAttribute_management("LAYER_NWI_polys", "NEW_SELECTION", "\"ATTRIBUTE\" LIKE 'E%' OR \"ATTRIBUTE\" LIKE 'P%'OR \"ATTRIBUTE\" LIKE 'L%'")
...
print("IA model done: Sedge Wren.")
