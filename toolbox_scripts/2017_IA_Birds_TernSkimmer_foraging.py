...
ModelType = "Birds_TernSkimmer_foraging"
...
if EXorHIST == "Extant":
    selectQuery = "\"IA_MODEL\" = '01ETES_CWB' OR \"IA_MODEL\" = '01ESHR_TER'"
    IAmodel = "Multiple_TernSkimE"
elif EXorHIST == "Historical":
    selectQuery = "\"IA_MODEL\" = '01HTES_CWB' OR \"IA_MODEL\" = '01HSHR_TER'"
    IAmodel = "Multiple_TernSkimH"
...
################### Buffer EOs
###################
arcpy.Buffer_analysis(in_EOs, "in_EOs_buff", 10000, "FULL", "ROUND", "ALL")
print("EOs buffered 10 km.")
