# ---------------------------------------------------------------------------
# IA_Invertebrates_BarrensHabitatLepidoptera.py
# Created on: 2012 May
...
ModelType = "Invertebrates_BarrensHabitatLepidoptera"
...
if EXorHIST == "Extant":
    selectQuery = "IA_MODEL = '01ETER_BAR'"
    IAmodel = "01ETER_BAR"
...
#####################
arcpy.Buffer_analysis(in_EOs, "temp_buff", "1200", "FULL", "ROUND", "ALL", "")
...
arcpy.AddJoin_management("LAYER_EOs", "SCIEN_NAME", "C:/_Schmid/_project/Important_Areas/GIS_Data/IA_Process.gdb/BarrensHabitat", "BarrensHabitat")
arcpy.SelectLayerByAttribute_management("LAYER_EOs", "NEW_SELECTION", "\"BarrensHabitat\" IS NOT NULL")
...
arcpy.AddMessage("IA model done: Invertebrates_BarrensHabitatLepidoptera")
