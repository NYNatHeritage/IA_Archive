...
if EXorHIST == "Extant":
    selectQuery = "IA_MODEL = '01ETER_MLH'"
    IAmodel = "01ETER_NLS"
...
################### Buffer selected EOs 0.5 miles
###################
arcpy.Buffer_analysis(in_EOs, "in_EOs_buff", 402.336, "FULL", "ROUND", "ALL", "")
