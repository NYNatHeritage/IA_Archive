...
################### Erase Hudson River
###################
arcpy.Erase_analysis("in_EOs_buff", "M:\\gis_util\\connectfiles\\gisview@gisprod_default_10.0.sde\\SDEADMIN.nc_major_waterbody", "Erase")
...
print("IA model done: Alleghany Woodrat.")
