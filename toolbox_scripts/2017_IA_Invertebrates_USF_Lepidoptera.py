...
ModelType = "Invertebrates_UnderstoryFoodplantAssocwOpeningsLepidoptera"
...
if EXorHIST == "Extant":
    selectQuery = "IA_MODEL = '01ETER_USF'"
    IAmodel = "01ETER_USF"
...
#####################
arcpy.Buffer_analysis(in_EOs, "temp_buff", "1300", "FULL", "ROUND", "ALL", "")
...
arcpy.AddJoin_management("LAYER_EOs", "SCIEN_NAME", "F:/_Schmid/_project/Important_Areas/GIS_Data/IA_Process.gdb/UnderstoryFoodplantLepAssocWithOpenings", "UnderstoryFoodplantLep")
arcpy.SelectLayerByAttribute_management("LAYER_EOs", "NEW_SELECTION", "\"UnderstoryFoodplantLep\" IS NOT NULL")

##################### Clip the communities with the buffer
#####################
...
print("IA model done: Invertebrates_UnderstoryFoodplantAssocwOpeningsLepidoptera")
