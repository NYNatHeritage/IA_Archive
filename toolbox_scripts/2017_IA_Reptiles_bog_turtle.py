...
arcpy.SelectLayerByAttribute_management("LAYER_NWI_polys", "NEW_SELECTION", "\"ATTRIBUTE\" LIKE 'R%' OR \"ATTRIBUTE\" LIKE 'P%'")
...
print("IA model done: Bog Turtle.")
