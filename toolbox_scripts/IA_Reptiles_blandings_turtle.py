...
arcpy.AddMessage("Blandings Turtle (Emydoidea blandingii) model")
...
arcpy.SelectLayerByAttribute_management("LAYER_NWI_polys", "NEW_SELECTION", "\"SYSTEM\" = 'R' OR \"SYSTEM\" = 'P'OR \"SYSTEM\" = 'L'")
...
arcpy.AddMessage("IA model done: Blandings Turtle.")
