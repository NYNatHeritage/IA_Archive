...
print("Eastern Mud Turtle (Kinosternon subrubrum) model")
...
print("LAYER_Hydro24K have been selected.")
...
arcpy.MakeRasterLayer_management( "D:\\Git_Repos\\IA_geoprocessing_scripts\\EOs_test_for_scripts.gdb\\LULC_HRE_10", "LAYER_CCAP_developed", "\"VALUE\" = 2 OR \"VALUE\" = 3")
...
arcpy.CopyFeatures_management ("Contiguous_Mud", FinalFC_gdb)

print("IA model done: Eastern Mud Turtle.")
