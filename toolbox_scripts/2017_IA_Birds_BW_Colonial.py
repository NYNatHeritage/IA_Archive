...
print("Beach/Wetland Colonial Waterbirds CCAP Unconsolidated shore and EO intersection, buffered 200m.")
...
print("Beach/Wetland Colonial Waterbirds CCAP estuarine emergent and EO intersection, buffered 6.25m.")
...
print("IA model done: Beach/Wetland Colonial Birds.")
